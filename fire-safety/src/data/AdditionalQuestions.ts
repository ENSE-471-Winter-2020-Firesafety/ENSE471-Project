...
export const AdditionalQuestions: AdditionalQuestionType[] = [
    {
        group: 'Police emergencies',
        usefulQuestions: [
    ...
    {
        group: 'Dangerous goods situations',
        usefulQuestions: [
